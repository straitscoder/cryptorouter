...
func NewFromSetting(settings *Settings, flagset map[string]bool) (*TradingEngine, error) {
	newEngineMutex.Lock()
	defer newEngineMutex.Unlock()
	if settings == nil {
...
func (tradeEngine *TradingEngine) Stop() {
	newEngineMutex.Lock()
	defer newEngineMutex.Unlock()
...
func (tradeEngine *TradingEngine) GetExchangeByName(exchName string) (exchange.IBotExchange, error) {
	return tradeEngine.ExchangeManager.GetExchangeByName(exchName)
}

// UnloadExchange unloads an exchange by name
func (tradeEngine *TradingEngine) UnloadExchange(exchName string) error {
...
func (tradeEngine *TradingEngine) GetExchanges() []exchange.IBotExchange {
...
func (tradeEngine *TradingEngine) LoadExchange(name string, wg *sync.WaitGroup) error {
...
func (tradeEngine *TradingEngine) SetupExchanges() error {
